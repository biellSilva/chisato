...
class IncursaoView(discord.ui.View):
    ...
    async def button_DPS(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        await self.ensure_group(interaction, button)
    ...
    async def button_DEL(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        if not interaction.user.guild_permissions.kick_members and interaction.user.name not in interaction.message.embeds[0].footer.text:
    ...
    async def ensure_group(self, interaction: discord.Interaction, button: discord.ui.Button):
